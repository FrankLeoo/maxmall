package com.maxmall.common.base.enums;
...
public enum ErrorCodeEnum {
	...
	GL99990405(99990403, "商户不存在，merchantId=%s"),
	/**
...
//	 1001 用户中心
	 ...
	 * Uac 10015009 error code enum.
	 */
	UAC10016001(10016001, "分销商不存在, distributor=%s"),

	UAC10016002(10016002, "分销商已经存在, distributor=%s"),

	UAC10016003(10016003, "分销商已经审核"),
...
// 1003 订单中心
	...
	OMC10031017(10031017, "退货申请单已经审核"),

	OMC10031018(10031018, "退货申请单未审核"),
	/**
...
// 1005 任务中心
	 ...
	 * 优惠券相关
	 */
	TPC100600001(100600001, "优惠券不存在, coupon=%s"),

	TPC100600002(100600002, "优惠券关联不存在"),

	TPC100600003(100600003, "活动不存在, promotion=%s"),
	;

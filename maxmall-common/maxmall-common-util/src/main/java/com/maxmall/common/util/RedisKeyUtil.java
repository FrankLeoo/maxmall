...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "maxmall:restPwd";
	private static final String ACTIVE_USER = "maxmall:activeUser";
	private static final String SEND_SMS_COUNT = "maxmall:sms:count";
	private static final String SEND_EMAIL_CODE = "maxmall:email:code";
	private static final String ACCESS_TOKEN = "maxmall:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "maxmall:file:upload_file_size";
